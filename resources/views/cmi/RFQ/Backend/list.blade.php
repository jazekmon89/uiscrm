	...
	<div class="container-fluid">
		<div class="row">
			<div class="bem-table__container table-responsive">
				<table class="table table-hover table-striped {{ $type }} rfqs table-fixed-header">
					<thead>
						<tr>
							<th>RFQ Ref No</th>
							<th>RFQ Type</th>
						...
						<tr id="search-{{ $type }}-fields">
							...
							<th>
								<div class="bem-table__search-container input-group search-area">
									{{ Form::text('RFQStatusID', null, ['placeholder' => 'Search', 'class' => 'form-control bem-table__search-input']) }}
									<span class="input-group-btn">
										<button class="btn trigger"><i class="fa fa-search"></i>&nbsp;</button>
									</span>
								</div>
							...
							<th>
								<div class="bem-table__search-container input-group search-area">
									{{ Form::text('Name', null, ['placeholder' => 'Search', 'class' => 'form-control bem-table__search-input']) }}
									<span class="input-group-btn">
										<button class="btn trigger"><i class="fa fa-search"></i>&nbsp;</button>
									</span>
								</div>
							...
							<th>
								<div class="bem-table__search-container input-group search-area">
									{{ Form::text('Address', null, ['placeholder' => 'Search', 'class' => 'form-control bem-table__search-input']) }}
									<span class="input-group-btn">
										<button class="btn trigger"><i class="fa fa-search"></i>&nbsp;</button>
									</span>
								</div>
							...
							<th>
								<div class="bem-table__search-container input-group search-area">
									{{ Form::text('LodgementDate', null, ['placeholder' => 'Search', 'class' => 'form-control bem-table__search-input']) }}
									<span class="input-group-btn">
										<button class="btn trigger"><i class="fa fa-search"></i>&nbsp;</button>
									</span>
								</div>
							...
							<th>
								<div class="bem-table__search-container input-group search-area">
									{{ Form::text('BusinessAddress', null, ['placeholder' => 'Search', 'class' => 'form-control bem-table__search-input']) }}
									<span class="input-group-btn">
										<button class="btn trigger"><i class="fa fa-search"></i>&nbsp;</button>
									</span>
								</div>
					...
					<tbody>
						@if(!empty($rfqs))
							...
							@endforeach
						@endif
						<tr class="empty {{ $rfqs ? 'hidden' : '' }}"><td colspan="10" class="bem-text_center">No entries found.</td></tr>
					</tbody>
				</table>
			</div>
		</div>
