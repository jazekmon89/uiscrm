<script type="text/javascript">
    $(document).ready(function(){
        ...
        var ids_home = new Array('address_line_1', 'address_line_2', 'street_name', 'town_or_suburb', 'post_code', 'state', 'birth_country'), ids_mail = new Array('mail_address_line_1', 'mail_address_line_2', 'mail_town_or_suburb', 'mail_post_code', 'mail_state', 'mail_country');
