...
@push('nav-main-menu')
    <li>{!! link_to_route('admin-login', "Advisor Sign in") !!}</li>
        ...
        <div class="registrationform-wrap wrap-center">
            <div class="box ">
                <div class="box-header with-border">
                  <h5 class="box-title">New User - Creating New Account</h5>
                </div>
                <div class="box-body">
                    <section>
                        <div class="wizard">
                                ...
                                <div class="tab-pane active" role="tabpanel" id="step4">
                                    ...
                                    <form role="form" method="POST" action="{{ route('register-address-post') }}">
                                        ...
                                        <div class="form-group home">
                                            ...
                                            @endif
                                            <div class=''>
                                                <label for="address_line_1" class="control-label required">Street No:</label>
                                            ...
                                            <div class=''>
                                                <label for="address_line_2" class="control-label required">Street No:</label>
                                                <div class="{{ $errors->has('address_line_2') ? ' has-error' : '' }}">
                                                    <input id="address_line_2" type="text" class="form-control" name="address_line_2" value="@if(!empty(old('address_line_2'))){!!old('address_line_2')!!}@else{!!$all_details['address_line_2'] or ''!!}@endif" required autofocus>
