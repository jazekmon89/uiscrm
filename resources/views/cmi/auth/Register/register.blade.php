...
@section('body')
<div class="r-pad-2x">&nbsp;</div>
<div class="bem-form__container_padding_mobile">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <form role="form" method="POST" action="{{ route('register-post') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                        <div class="input-group input-append date" id="date_of_birth_cont">
                                            <input id="date_of_birth" type="text" class="form-control" name="date_of_birth" value="@if(!empty(old('date_of_birth'))){!!old('date_of_birth')!!}@else{!!$all_details['date_of_birth'] or ''!!}@endif" required><span class="input-group-addon add-on"><i class="bem-step__icons glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                ...
                                <div class="form-group">                                      
                                    <div class="pull-left"><a role="button" href="{{ route('register-front') }}" class="btn btn-primary next-step">Back</a></div>
                                    <div class="pull-right"><button type="submit" class="btn btn-primary next-step">Continue</button></div>                                                                                  
                                </div>
                            </form>                                                                                  
                        </div>
                        <div class="r-pad-4x">&nbsp;</div>
                    </div>
                </div>
            </section>
        </div>
