...
<body class="@body_class() {{ !Auth::check() ? 'guest' : (Auth::user()->is_adviser ? 'adviser' : 'client') }} bem-background__container-blue-white-slant bem-background__container-blue-white-top-btm-half">  
