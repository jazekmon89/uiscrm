    <div class="form-group">
        <div class="prev-home-addr-form">
            ...
            @endif
            @if(false) // removed as per client changes 03/09/2017
            ...
            <div class=''>
                <label for="prev_home_address_line_1_{{$i}}" class="control-label">Address line 1.</label>
                <div class="@if(isset($form_errors['prev_home_address_line_1_'.$i])){{' has-error'}}@else{{''}})@endif">
                    <input id="prev_home_address_line_1_{{$i}}" type="text" class="form-control" name="prev_home_address_line_1_{{$i}}" value="@if(isset($all_details['prev_home_address_line_1_'.$i])){{$all_details['prev_home_address_line_1_'.$i]}}@else{{''}}@endif" autofocus>
            ...
            <div class=''>
                ...
                <div class="@if(isset($form_errors['prev_home_address_line_2_'.$i])){{' has-error'}}@else{{''}})@endif">
                    <input id="prev_home_address_line_1_{{$i}}" type="text" class="form-control" name="prev_home_address_line_2_{{$i}}" value="@if(isset($all_details['prev_home_address_line_2_'.$i])){{$all_details['prev_home_address_line_2_'.$i]}}@else{{''}}@endif" autofocus>
