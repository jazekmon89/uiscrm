    <div class="form-group">
        <div class="prev-home-addr-form">
            ...
            <div class=''>
                ...
                <div class="">
                    <input id="prev_home_address_line_1_{{$index}}" type="text" class="form-control" name="prev_home_address_line_1_{{$index}}" value="" required autofocus>
                </div>
            </div>
            <div class=''>
                <label for="prev_home_address_line_2_{{$index}}" class="control-label">Address line 2</label>
                <div class="">
