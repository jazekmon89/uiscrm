...
@endphp
	<h5 class="bem-text_center">Claim History</h5>

	{{-- Motor Vehicle --}}
	@if(app('request')->PolicyTypeID === '8F61A25E-1B5E-460A-969D-1BE8B0ACAB3F')
		<p class="grid-100">In the last 5 years have you made any motor vehicle claims ?</p>
	@else
		<p class="grid-100">In the last 5 years have you suffered any losses or otherwise or has any claims made against you ?</p>
	@endif
	<div class="form-group disp-inline-block grid-30">
	...
	@if(app('request')->PolicyTypeID === '8F61A25E-1B5E-460A-969D-1BE8B0ACAB3F')
		<p class="grid-100">In the last 5 years have you hade any other claims related to the covers selected i.e. Machinery Breakdown, Business Interruption, Public Liability, etc.?</p>
		...
		<div class="claims-container grid-100 hidden" id="claims-others">
			...
			<thead>
				<tr>
					...
					<th class="col-md-2" style="width: 36%">Description</th>
				</tr>
			</thead>
