                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="step3">
                                    ...
                                    <form role="form" method="POST" action="{{ route('register-profile-post') }}">
                                        ...
                                        <label for="first_name" class="control-label">Additional Information Required</label>
                                        ...
                                        <div class="form-group">                                       
                                            <ul class="list-inline">
                                                <li class="pull-left"><a role="button" href="{{ route('register') }}" class="btn btn-primary btn-flat btn-burgundy next-step">Back</a></li>
