        ...
        <div class="row">               
            <nav class="navbar navbar-default navbar-static-top">
               ...
               <div class="collapse navbar-collapse">                      
                   ...
                   <div class="bem-search-form__container">
...
<div class="bem-page__container">
    ...
    <div class="bem-page__container-row">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="bem-page__container-grid bem-page__container-white bem-page__container-rounded">
                        <h4 class="bem-page__heading-text">@dynamicblock('title')</h4> 
                         @yield('content')                     
                    </div>
                </div>
            </div>      
