            ...
            <div class="bem-row"> 
               <ul class="bem-contact-details__container">
                    ...
                    <li class="bem-contact-details_email">
                        <a href="mailto:info@justcoffeeinsurance"><span><i class="fa fa-envelope"></i> info@justcoffeeinsurance.com.au</span></a>
                    </li>
               </ul>                              
            </div>
        </div>
        ...
        /*$(window).scroll(function() {
            ...
            if($(window).width() > 768) {
                ...
                if(jciLogoImg.offset().top > 250) {
                    ...
                    // Fade in and scale logo image on scroll to top 
