                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step4">
                        ...
                        <form role="form" method="POST" action="{{ route('register-address-post') }}">
                            {{ csrf_field() }}                           
                            <h5 class="bem-text_left">Current Home Address</h5>
                            <div class="form-group home">                                
                                <input id="home_owner" type="checkbox" class="register-checkbox" name="home_owner" value="" @if(!empty(old('home_owner'))){!!'checked'!!}@else{!! $all_details['home_owner'] or '' !!} @endif>&nbsp;&nbsp;&nbsp;<label for="home_owner">{{ trans('messages.home_owner') }}</label>                                       
                            </div>
                            ...
                            <div class="form-group">                                                       
                                <input id="mail_home_owner" type="checkbox" class="register-checkbox" name="mail_home_owner" value="" {{ $mail_home_owner }} >
                                    &nbsp;&nbsp;&nbsp;<label for="mail_home_owner">{{ trans('messages.mailing_addr') }}</label>                                                     
                            </div>
                            <div class="collapse" id="mailing-address-container">
                                ...
                                <h5 class="bem-text_left">Town / Suburb</h5>
                                <div class="form-group"> 
                                ...
                                <div class="form-group">     
                                    ...
                                    <div class="{{ $errors->has('mail_state') ? ' has-error' : '' }}">
                                        {{ Form::jInput('select', 'mail_state', $state_options, (!empty(old('mail_state'))?old('mail_state'):array_key_exists('mail_state',$all_details)?$all_details['mail_state']:''), ['class'=>'form-control', 'id'=>'mail_state', 'required'=>true, 'autofocus'=>true]) }}
                            ...
                            <h5 class="bem-text_left prev-address-group init-hide">Previous Home Address</h5>                                         
                            <div class="ajax-group">
                            </div>                            
                            <div class="form-group">                                                                  
                                <div class="pull-left"><a role="button" href="{{ route('register-profile') }}" class="btn btn-maroon next-step">Back</a></div>
