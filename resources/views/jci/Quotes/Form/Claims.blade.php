...
@php 
	$repeat = ["repeat" => ".claims-list", "container" => "#claim-list-container", "id" => "claims-repeater", "class" => "btn btn-dark-orange",  "text" => "+ claims"];
...
@endphp
	...
	<div class="row">
		...
		<div class="form-group col-md-7">
			{{ Form::jBoolean("Claims.trigger.claims", ['Y' => 'Yes', 'N' => 'No'], $has_claims ? 'Y' : NULL, ['class' => 'claims-trigger', 'data-target' => '#claims-claims'])}}
		</div>
	</div>
<div class="claims-container grid-100 hidden" id="claims-claims">
<div class="bem-table__container sm-table-responsive">
	<table class="table table-striped">
	   <thead class="bem-table-header__container_light-orange">
	      <tr>
	         @if(false)
	         <th class="col-md-2 bem-text_center" style="width: 5%;">@include('Quotes.Form.partials.question-repeat-buttons', $repeat)</th>
	         <th class="col-md-3 bem-text_center" style="width: 18%">Insurer</th>
	         <th class="col-md-4 bem-text_center" style="width: 25%" colspan='2'>Insurance Period <br/>(Begin - End)</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%;{{ app('request')->PolicyTypeID === '8F61A25E-1B5E-460A-969D-1BE8B0ACAB3F' ? 'display:none;' : '' }}">Type of Claim</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%">Amount Paid</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%">At Fault</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%">Finalized</th>
	         @endif
	         <th class="col-md-2 bem-text_center" style="width: 5%;">@include('Quotes.Form.partials.question-repeat-buttons', $repeat)</th>
	         <th class="col-md-3 bem-text_center" style="width: 21%">Insurer</th>
	         <th class="col-md-4 bem-text_center" style="width: 13%">Accident date</th>
	         @if(false)
	         <th class="col-md-2 bem-text_center" style="width: 13%;">Type of Claim</th>
	         @endif
	         <th class="col-md-2 bem-text_center hidden" style="width: 13%;">Type of Claim</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%">Amount Paid</th>
	         <th class="col-md-2 bem-text_center {{$disptext == 'Workers Compensation'?'hidden':''}}" style="width: 13%">At Fault</th>
	         <th class="col-md-2 bem-text_center" style="width: 13%">Finalized</th>
	         <th class="col-md-2 bem-text_center" style="width: {{$disptext == 'Workers Compensation'?35:22}}%">Description</th>
	      </tr>
	   </thead>
	      ...
	      <tr 
			...
			@if(false)
				...
				@elseif(false && $disptext == 'Workers Compensation')
					{{ Form::jInput("select", "Claims.Claims.{$i}.TypeOfClaim", $_claim_type, ['class' => 'form-control']) }}
				@else
			...
			@if(false)
			<td class="form-group bem-text_center">
			{{ Form::jInput("checkbox", "Claims.Claims.{$i}.AtFault", 'Y', false) }}
			</td>
			<td class="form-group bem-text_center">
			{{ Form::jInput("checkbox", "Claims.Claims.{$i}.Finalized", 'Y', false) }}
			</td>
			@endif
	...
	@if(app('request')->PolicyTypeID === '8F61A25E-1B5E-460A-969D-1BE8B0ACAB3F')
		<div class="row">
			...
			<div class="form-group col-md-7">
				{{ Form::jBoolean("Claims.trigger.others", ['Y' => 'Yes', 'N' => 'No'], $has_claims ? 'Y' : NULL, ['class' => 'claims-trigger', 'data-target' => '#claims-others'])}}
			</div>
		</div>
		@php
		...
		<div class="bem-table__container sm-table-responsive">
			...
			<thead class="bem-table-header__container_light-orange">
				<tr>
					...
					@endif
					<th class="col-md-2 bem-text_center" style="width: 5%;">@include('Quotes.Form.partials.question-repeat-buttons', $repeat)</th>
					<th class="col-md-3 bem-text_center" style="width: 13%">Insurer</th>
					<th class="col-md-4 bem-text_center" style="width: 13%">Accident date</th>
					<th class="col-md-2 bem-text_center" style="width: 10%">Type of Claim</th>
					@if(false)
					<th class="col-md-2 bem-text_center hidden" style="width: 10%">Type of Claim</th>
					@endif
					<th class="col-md-2 bem-text_center" style="width: 13%">Amount Paid</th>
					<th class="col-md-2 bem-text_center {{$disptext == 'Workers Compensation'?'hidden':''}}" style="width: 10%">At Fault</th>
					<th class="col-md-2 bem-text_center" style="width: 10%">Finalized</th>
					<th class="col-md-2 bem-text_center" style="width: {{$disptext == 'Workers Compensation'?26:16}}%">Description</th>
				</tr>
			</thead>
			<tbody id="claim-others-container">
				...
				<tr 
					...
					@if(false)
					<td class="form-group bem-text_center">
						{{ Form::jInput("checkbox", "Claims.OtherClaims.{$i}.AtFault", 'Y', false) }}
					</td>
					<td class="form-group bem-text_center">
						{{ Form::jInput("checkbox", "Claims.OtherClaims.{$i}.Finalized", 'Y', false) }}
					</td>
					@endif
					@if($disptext == 'Workers Compensation')
					<td class="form-group hidden">
