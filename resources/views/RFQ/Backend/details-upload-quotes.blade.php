			...
			<div class="modal-content box">
				...
				<div class="modal-body">
					<div id="upload-quotes">
						{{ Form::open(['route' => ['rfqs.upload-csv-quotes'], 'files' => true]) }}
							<div class="input-group row">
								...
								<div class="input-group-btn">
									<button class="btn btn-default btn-primary btn-action" onclick="return uploadQuotes(this)">Import</button>
								</div>
					...
					<div id="save-quotes">
						...
						{{ Form::open(['route' => ['rfqs.save-quotes', $RFQ['RFQID']], 'class' => 'hidden']) }}
					    	<table class="table table-condensed table-hover table-striped">
					    		<thead></thead>
					    		<tbody></tbody>
					    	</table>
