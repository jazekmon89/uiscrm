...
<head>
	...
	#header #main-menu .navbar-nav.menu{margin: 5px 0;}
                                ...
                                @else
                                    @if(Auth::check() && Auth::user()->is_adviser)
                                        ...
                                        <li class="active-menu">
                                            <a href="{{ url("/") }}">General Insurance</a>
                                        </li>
    ...
    <div id="page-title" class="container">
        <div class="row">
            <div class="title col-md-7">
                <!-- Locate where page title is generated-->
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="" style="margin: 0">@page_title()</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="toolbars col-md-5">
                @if($document->hasToolbar('title-toolbars'))
                <nav class="navbar navbar-default" style="margin-bottom: 0;background:none;border:0;">
                    <div class="container-fluid">
                        @toolbars('title-toolbars', 'nav navbar-nav navbar-right')
                    </div>
                </nav>
                @endif
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 pull-left">
                    <strong>Copyright</strong> &#169; <strong>2016
