			...
			search = function() {
				var form = $('.profiles form'),
					...
					makeRow = function(data) {
						...
						row += "<td>"+ (getData('HomeAddress.AddressLine1', data, '')+' '+getData('HomeAddress.AddressLine2', data, '')+' '+getData('HomeAddress.City', data, '')+' '+getData('HomeAddress.State', data, '')+' '+getData('HomeAddress.Postcode', data, '')+' '+getData('HomeAddress.Country', data, '')).replace(/ +(?= )/g,'')+"</td>";
						...
						row += "<td>"+ (getData('PostalAddress.AddressLine1', data, '')+' '+getData('PostalAddress.AddressLine2', data, '')+' '+getData('PostalAddress.City', data, '')+' '+getData('PostalAddress.State', data, '')+' '+getData('PostalAddress.Postcode', data, '')+' '+getData('PostalAddress.Country', data, '')).replace(/ +(?= )/g,'')+"</td>";
					...
					bindClick = function(row) {
						row.click(function() {
							...
							function callback(client) {	
								...
								$('#in-q-addressline1').val(getData('InsurableBusiness.PostalAddress.AddressLine1', data, 'N/A'));
								$('#in-q-addressline2').val(getData('InsurableBusiness.PostalAddress.AddressLine2', data, 'N/A'));
