...
@title($client->InsuredName . " - RECOMMENDED COVERS")

@page_title('<strong>' . $client->InsuredName ."</strong> - RECOMMENDED COVERS")

{{-- Document/Body title --}}
@body_class('client-profiles-recommendations layout-box')
...
<div class="section-01">
		...
		<div class="tabs row">
			...
			<div class="cover-selection-form">
				
					<div class="col-md-12">
						<p></p>
						<p class="col-md-12">To recommend cover options to your client select a cover from the left and click the <b>"Select"</b> button.</p>	
					</div>
