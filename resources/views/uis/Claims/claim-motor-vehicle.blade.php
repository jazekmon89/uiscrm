...
{{-- Page title --}}
@page_title('Motor Vehicle Claim')
...
@cssblock("uis.Claims.css.styles",'breadcrumb-styles')
...
@jsblock("uis.Claims.js.motor-vehicle-scripts", "motor_scripts")
...
<div id="cstm-tabs-default">
    <ul class="nav nav-tabs">
      <li><a href="#" data-toggle="tab"><span class="badge">1</span>Get A Claim</a></li>
