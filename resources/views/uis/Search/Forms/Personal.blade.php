<div class='search search-insurance'>
	...
	<div class="col-md-12">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group row">
					<div class="col-md-5 text-left">State:</div>
					<div class="col-md-7 text-right">{{ Form::jInput('text', 'Address.State', null, ['class' => 'form-control']) }}</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group row">
					<div class="col-md-5 text-left">Postcode:</div>
					<div class="col-md-7 text-right">{{ Form::jInput('text', 'Address.Postcode', null, ['class' => 'form-control']) }}</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group row">
					<div class="col-md-5 text-left">Country:</div>
					<div class="col-md-7 text-right">{{ Form::jInput('text', 'Address.Country', null, ['class' => 'form-control']) }}</div>
				</div>
			</div>	
		</div>
	</div>
